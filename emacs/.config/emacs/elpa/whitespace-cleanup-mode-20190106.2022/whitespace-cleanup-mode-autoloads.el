...
If called interactively, enable Whitespace-Cleanup mode if ARG is positive, and
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "whitespace-cleanup-mode" '("turn-on-whitespace-cleanup-mode" "whitespace-cleanup-mode-")))
