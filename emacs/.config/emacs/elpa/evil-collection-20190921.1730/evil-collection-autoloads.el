...
Set up `evil' bindings for `2048-game'." nil nil)
...
Set up `evil' bindings for `ag'." nil nil)
...
Set up `evil' bindings for `alchemist'." nil nil)
...
Set up `evil' bindings for `anaconda-mode'." nil nil)
...
Set up `evil' bindings for `apropos'." nil nil)
...
Set up `evil' bindings for `arc-mode'." nil nil)
...
Set up `evil' bindings for `bookmark'." nil nil)
...
Set up `evil' bindings for `buff-menu'.." nil nil)
...
Set up `evil' bindings for `calc'." nil nil)
...
Set up `evil' bindings for `calendar'." nil nil)
...
Set up `evil' bindings for `cider'." nil nil)
...
Set up `evil' bindings for `cmake-mode'." nil nil)
...
Set up `evil' bindings for `comint'." nil nil)
...
Set up `evil' bindings for `company'." nil nil)
...
Set up `evil' bindings for `compile'." nil nil)
...
Set up `evil' bindings for `cus-theme'." nil nil)
...
Set up `evil' bindings for `Custom-mode'." nil nil)
...
Set up `evil' bindings for `daemons'." nil nil)
...
Set up `evil' bindings for deadgrep.." nil nil)
...
Set up `evil' bindings for `debbugs-gnu-mode'." nil nil)
...
Set up `evil' bindings for `debug'." nil nil)
...
Toggle visiting diff buffers in motion state." t nil)

(autoload 'evil-collection-diff-mode-setup "evil-collection-diff-mode" "\
Set up `evil' bindings for `diff-mode'." nil nil)
...
Set up `evil' bindings for `dired'." nil nil)
...
Set up `evil' bindings for `disk-usage'." nil nil)
...
Set up `evil' bindings for `doc-view'." nil nil)
...
Set up `evil' bindings for `ebib'." nil nil)
...
Set up `evil' bindings for EDBI." nil nil)
...
Set up `evil' bindings for `edebug'." nil nil)
...
Set up `evil' bindings for `eglot'." nil nil)
...
Set up `evil' bindings for `elfeed'." nil nil)
...
Set up `evil' bindings for `elisp-mode'." nil nil)
...
Set up `evil' bindings for `elisp-refs'." nil nil)
...
Set up `evil' bindings for `elisp-slime-nav'." nil nil)
...
Set up `evil' bindings for `emms-browser'." nil nil)

(autoload 'evil-collection-emms-playlist-setup "evil-collection-emms" "\
Set up `evil' bindings for `emms-playlist'." nil nil)

(autoload 'evil-collection-emms-setup "evil-collection-emms" "\
Set up `evil' bindings for `emms'." nil nil)
...
(autoload 'evil-collection-epa-setup "evil-collection-epa" nil nil nil)
...
Set up `evil' bindings for `ert'." nil nil)
...
Set up `evil' bindings for `eshell'." nil nil)
...
Set up `evil' with `eval-sexp-fu'." nil nil)
...
Set up `evil' bindings for evil-mc." nil nil)
...
Set up `evil' bindings for `eww'." nil nil)
...
Set up `evil' bindings for `flycheck'." nil nil)
...
Set up `evil' bindings for `flymake'." nil nil)
...
Set up `evil' bindings for `free-keys'." nil nil)
...
Set up bindings for `geiser'." nil nil)
...
Set up `evil' bindings for `ggtags'." nil nil)
...
Setup `evil' keybindings for `git-timemachine'." nil nil)
...
Set up `evil' bindings for `go-mode'." nil nil)
...
Set up `evil' bindings for `grep'." nil nil)
...
Set up `evil' bindings for `guix'." nil nil)
...
Set up `evil' bindings for `hackernews-mode'." nil nil)
...
Set up `evil' bindings for `helm'." nil nil)
...
Set up `evil' bindings for `help'." nil nil)
...
Set up `evil' bindings for `helpful'." nil nil)
...
Set up `evil' bindings for `hg-histedit'." nil nil)
...
Set up `evil' bindings for `hungry-delete'." nil nil)
...
Set up `evil' bindings for `ibuffer'." nil nil)
...
Set up `evil' bindings for `image-mode'." nil nil)
...
(autoload 'evil-collection-image+-setup "evil-collection-image+" "\
Set up `evil' bindings for `image+'." nil nil)
...
Set up `evil' bindings for `image-dired-thumbnail-mode'." nil nil)
...
Set up `evil' bindings for `imenu-list'." nil nil)
...
Set up `evil' bindings for `indium'." nil nil)
...
Set up `evil' bindings for `info-mode'." nil nil)
...
Set up `evil' bindings for `ivy-mode'." nil nil)
...
Set up `evil' bindings for `js2-mode'." nil nil)
...
Set up `evil' bindings for `kotlin-mode'." nil nil)
...
Set up `evil' bindings for `leetcode'." nil nil)
...
Set up `evil' bindings for `lispy'." nil nil)
...
Set up `evil' bindings for `log-edit'." nil nil)
...
Set up `evil' bindings for `log-view'." nil nil)
...
Set up `evil' bindings for `lsp-ui-imenu'." nil nil)
...
Set up `evil' bindings for `lua-mode'." nil nil)
...
Set up `evil' bindings for `macrostep'." nil nil)
...
Set up `evil' bindings for `magit'." nil nil)
...
Set up `evil' bindings for `magit-todos'." nil nil)
...
Set up `evil' bindings for `man'." nil nil)
...
Initialize minibuffer for `evil'." nil nil)
...
Set up `evil' bindings for `monky'." nil nil)
...
is already done earlier." nil nil)
...
Set up `evil' bindings for `mu4e-conversation'." nil nil)
...
Set up `evil' bindings for `neotree'." nil nil)
...
Set up `evil' bindings for `notmuch'." nil nil)
...
Set up `evil' bindings for `nov'." nil nil)
...
Set up `evil' bindings for `occur'." nil nil)
...
Set up `evil' bindings for `omnisharp'." nil nil)
...
Set up `evil' bindings for `outline'." nil nil)
...
Set up `evil' bindings for `p4'." nil nil)
...
Set up `evil' bindings for `package-menu'." nil nil)
...
Set up `evil' bindings for `pass-mode'." nil nil)
...
Set up `evil' bindings for `pdf-view'." nil nil)
...
Set up `evil' bindings for `popup'." nil nil)
...
Set up `evil' bindings for `proced'." nil nil)
...
Set up `evil' bindings for `list-processes'." nil nil)
...
Set up `evil' bindings for `prodigy'." nil nil)
...
Set up `evil' bindings for `profiler'." nil nil)
...
Set up `evil' bindings for `python'." nil nil)
...
Set up `evil' bindings for `quickrun'.." nil nil)
...
Set up `evil' bindings for `racer'." nil nil)
...
Set up `evil' bindings for `realgud'." nil nil)
...
Set up `evil' bindings for `reftex'." nil nil)
...
Set up `evil' bindings for `restclient'." nil nil)
...
Set up `evil' bindings for `rjsx-mode'." nil nil)
...
Set up `evil' bindings for `robe'." nil nil)
...
Set up `evil' bindings for `rtags'." nil nil)
...
Set up `evil' bindings for `ruby'." nil nil)
...
Set up `evil' bindings for `simple'." nil nil)
...
Set up `evil' bindings for `slime'." nil nil)
...
Set up `evil' bindings for `term'." nil nil)
...
Set up `evil' bindings for `tetris'." nil nil)
...
Set up `evil' bindings for `tide'." nil nil)
...
Set up `evil' bindings for `transmission'." nil nil)
...
Set up `evil' bindings for `typescript-mode'." nil nil)
...
Set up unimpaired-like bindings." nil nil)
...
Set up `evil' bindings for `vc-annotate'." nil nil)
...
Set up `evil' bindings for `vc-dir'." nil nil)
...
Set up `evil' bindings for `vc-git'." nil nil)
...
Set up `evil' bindings for `vdiff-mode'." nil nil)
...
Set up `evil' bindings for `view'." nil nil)
...
Set up `evil' bindings for `vlf'." nil nil)
...
Set up `evil' bindings for `vterm'." nil nil)
...
Set up `evil' bindings for `w3m'." nil nil)
...
Set up `evil' bindings for `wdired'." nil nil)
...
Set up `evil' bindings for `wgrep'." nil nil)
...
Set up `evil' bindings for `which-key'." nil nil)
...
Set up `evil' bindings for `woman'." nil nil)
...
Set up `evil' bindings for `xref'." nil nil)
...
Set up `evil' bindings for `youtube-dl'." nil nil)
...
Set up `evil' bindings for `ztree'." nil nil)
